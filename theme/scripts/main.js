...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    if (window_width > 992) {
        ...
        $(nav).on("click", ".menu-cnt > ul > li > a", function () {
          ...
          if (!active) {
            ...
            if (sub_menu.length) {
              ...
              $(sub_menu).animate({ height: item_height }, 500, function () {
                $(sub_menu).css("height", "");
              });
            }
          }
      ...
      $(nav).on("click", ".text-uppercase > a", function (e) {
        e.preventDefault();
      });
    ...
    $(nav).on("click", ".menu-btn", function () {
      ...
      $(menu_cnt).animate({ height: h }, 300, function () {
        setTimeout(function () {
          if (active) {
    ...
    $(body).on("click", ".menu-inner-vertical .text-uppercase", function () {
    ...
    $(nav)
      ...
      .each(function () {
        if ($(this).attr("href") == window.location.href) {
          if ($(this).closest(".text-uppercase-menu").length) {
            $(this)
              .closest(
                ".text-uppercase.multi-level:not(.text-uppercase-submenu),.text-uppercase.mega-text-uppercase"
              )
              .addClass("active");
          } else {
  ...
  $.fn.expandItem = function () {
    ...
    $(t).animate({ height: h }, 300, function () {
      $(t).css("height", "");
    });
  };
