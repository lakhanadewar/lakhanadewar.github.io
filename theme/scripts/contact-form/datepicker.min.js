...
!(function (t) {
  ...
  function o(t, e) {
    return [31, h(t) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][e];
  }
  function l(t) {
    var e,
      i,
    ...
    for (t = { source: s, parts: a }, e = a.length, i = 0; e > i; i++)
      switch (a[i]) {
        case "dd":
        case "d":
          t.hasDay = !0;
  ...
  function d(e, i) {
    (this.$element = t(e)),
      (this.options = t.extend({}, d.DEFAULTS, t.isPlainObject(i) && i)),
      (this.isBuilt = !1),
      (this.isShown = !1),
      (this.isInput = !1),
      (this.isInline = !1),
  ...
  var u = t(window),
    ...
    x = /^\d{2,4}$/,
    C = "datepicker-inline",
    F = "datepicker-text-uppercase",
    S = "datepicker-top-left",
    I = "datepicker-top-right",
    M = "datepicker-bottom-left",
    V = "datepicker-bottom-right",
    T = [S, I, M, V].join(" "),
    Y = "datepicker-hide",
    N = Number,
    P = Math.min,
  ...
  (d.prototype = {
    ...
    init: function () {
      var e = this.options,
        ...
        a = e.endDate,
        n = e.date;
      e.language && t.extend(e, d.LANGUAGES[e.language]),
        (this.$trigger = t(e.trigger || i)),
        (this.isInput = i.is("input") || i.is("textarea")),
        (this.isInline = e.inline && (e.container || !this.isInput)),
        (this.format = l(e.format)),
    ...
    build: function () {
      ...
      this.isBuilt ||
        ...
        this.isInline
          ? t(i.container || s).append(e.addClass(C))
          : (t(c.body).append(e.addClass(F)), e.addClass(Y)),
        this.fillWeek());
    },
    unbuild: function () {
    ...
    bind: function () {
      var e = this.options,
        i = this.$element;
      t.isFunction(e.show) && i.on(v, e.show),
        t.isFunction(e.hide) && i.on(D, e.hide),
        t.isFunction(e.pick) && i.on(k, e.pick),
        this.isInput &&
          (i.on(m, t.proxy(this.keyup, this)),
          e.trigger || i.on(y, t.proxy(this.show, this))),
        this.$trigger.on(w, t.proxy(this.show, this));
    },
    unbind: function () {
      var e = this.options,
        i = this.$element;
      t.isFunction(e.show) && i.off(v, e.show),
        t.isFunction(e.hide) && i.off(D, e.hide),
        t.isFunction(e.pick) && i.off(k, e.pick),
        this.isInput &&
          (i.off(m, this.keyup), e.trigger || i.off(y, this.show)),
        this.$trigger.off(w, this.show);
    },
    showView: function (t) {
        ...
        switch (N(t)) {
          ...
          case "years":
            i.addClass(Y),
              s.addClass(Y),
              a.hasYear
                ? (this.fillYears(), e.removeClass(Y))
                : this.showView(0);
            break;
          case 1:
          case "months":
            e.addClass(Y),
              s.addClass(Y),
              a.hasMonth
                ? (this.fillMonths(), i.removeClass(Y))
                : this.showView(2);
            break;
          default:
            e.addClass(Y),
              i.addClass(Y),
              a.hasDay ? (this.fillDays(), s.removeClass(Y)) : this.showView(1);
        }
    },
    hideView: function () {
    ...
    place: function () {
      var t = this.options,
        ...
        p = S;
      u > o && u + r + o > a ? ((u -= o + c), (p = M)) : (u += r + c),
        d + h > s && ((d = d + n - h), (p = p.replace("left", "right"))),
        i
          .removeClass(T)
          .addClass(p)
          .css({ top: u, left: d, zIndex: parseInt(t.zIndex, 10) });
    },
    ...
    fillWeek: function () {
      var e,
        ...
        a = i.daysMin,
        n = "";
      for (a = t.merge(a.slice(s), a.slice(0, s)), e = 0; 6 >= e; e++)
    ...
    fillYears: function () {
      ...
      for (e = D; k >= e; e++)
        (c = new Date(l + e, d, u)),
          ...
          (y = l + e === f),
          (m = !1),
          r && ((m = c.getFullYear() < r.getFullYear()), e === D && (p = m)),
          !m &&
            h &&
            ((m = c.getFullYear() > h.getFullYear()), e === k && (w = m)),
          !m && n && (m = n.call(this.$element, c) === !1),
          (v += this.createItem({
            text: l + e,
    ...
    fillMonths: function () {
      ...
      for (e = 0; 11 >= e; e++)
        (u = new Date(l, e, d)),
          ...
          (m = !1),
          r &&
            ((p = u.getFullYear() === r.getFullYear()),
            (m = p && u.getMonth() < r.getMonth())),
          !m &&
            h &&
            ((w = u.getFullYear() === h.getFullYear()),
            (m = w && u.getMonth() > h.getMonth())),
          !m && n && (m = n.call(this.$element, u) === !1),
          (g += this.createItem({
            index: e,
            text: a[e],
      ...
      this.$yearPrev.toggleClass(s, p),
        this.$yearNext.toggleClass(s, w),
        this.$yearCurrent.toggleClass(s, p && w).html(l + i.yearSuffix || ""),
        this.$months.html(g);
    },
    fillDays: function () {
      var e,
      ...
      for (
        ...
        (D = new Date(m, y, i)),
          (F = !1),
          u && (F = D.getTime() < u.getTime()),
          !F && d && (F = d.call(this.$element, D) === !1),
          I.push(
            this.createItem({
              text: i,
              view: "day prev",
      ...
      for (i = 1; e >= i; i++)
        (D = new Date(p, w, i)),
          ...
          (F = !1),
          u && (F = D.getTime() < u.getTime()),
          !F && c && (F = D.getTime() > c.getTime()),
          !F && d && (F = d.call(this.$element, D) === !1),
          V.push(
            this.createItem({
              text: i,
              view: F ? "day disabled" : S ? "day picked" : "day",
              picked: S,
              disabled: F,
            }),
          );
      this.$monthPrev.toggleClass(n, x),
        this.$monthNext.toggleClass(n, C),
        this.$monthCurrent
          .toggleClass(n, x && C)
          .html(a.yearFirst ? p + r + " " + h[w] : h[w] + " " + p + r),
        this.$days.html(I.join("") + V.join(" ") + M.join(""));
    },
    click: function (e) {
      var i,
        s,
      ...
      if ((e.stopPropagation(), e.preventDefault(), !o.hasClass("disabled")))
        switch (
          ...
          case "years prev":
          case "years next":
            (i = "years prev" === h ? i - 10 : i + 10),
              (r = o.text()),
              (n = x.test(r)),
              n &&
                ((i = parseInt(r, 10)), (this.date = new Date(i, s, P(a, 28)))),
              (this.viewDate = new Date(i, s, P(a, 28))),
              this.fillYears(),
              n && (this.showView(1), this.pick("year"));
            break;
          case "year prev":
          case "year next":
            (i = "year prev" === h ? i - 1 : i + 1),
              (this.viewDate = new Date(i, s, P(a, 28))),
              this.fillMonths();
            break;
          case "year current":
          ...
          case "day next":
          case "day":
            (s = "day prev" === h ? s - 1 : "day next" === h ? s + 1 : s),
    ...
    clickDoc: function (t) {
      for (var e, i = t.target, s = this.$trigger[0]; i !== c; ) {
        if (i === s) {
          e = !0;
          break;
        }
    ...
    setValue: function (t) {
      ...
      (t = e(t) ? t : ""),
        this.isInput
          ? i.val(t)
          : this.isInline
          ? this.options.container && i.text(t)
          : i.text(t);
    },
    show: function () {
      this.isBuilt || this.build(),
        this.isShown ||
          ...
          ((this.isShown = !0),
          this.$picker.removeClass(Y).on(w, t.proxy(this.click, this)),
          this.showView(this.options.startView),
          this.isInline ||
            (u.on(g, (this._place = r(this.place, this))),
            f.on(w, (this._clickDoc = r(this.clickDoc, this))),
            this.place()));
    },
    hide: function () {
      this.isShown &&
        (this.trigger(D).isDefaultPrevented() ||
          ((this.isShown = !1),
          this.$picker.addClass(Y).off(w, this.click),
          this.isInline || (u.off(g, this._place), f.off(w, this._clickDoc))));
    },
    update: function () {
    ...
    pick: function (t) {
      var e = this.$element,
        i = this.date;
      this.trigger(k, { view: t || "", date: i }).isDefaultPrevented() ||
    ...
    getMonthName: function (e, a) {
      var n = this.options,
        r = n.months;
      return (
        t.isNumeric(e) ? (e = N(e)) : s(a) && (a = e),
        a === !0 && (r = n.monthsShort),
        r[i(e) ? e : this.date.getMonth()]
      );
    },
    getDayName: function (e, a, n) {
      var r = this.options,
        h = r.days;
      return (
        t.isNumeric(e) ? (e = N(e)) : (s(n) && (n = a), s(a) && (a = e)),
        (h = n === !0 ? r.daysMin : a === !0 ? r.daysShort : h),
        h[i(e) ? e : this.date.getDay()]
      );
    },
    getDate: function (t) {
      var e = this.date;
    ...
    setDate: function (i, s) {
      var n = this.options.filter;
      if (a(i) || e(i)) {
        if (
          ((i = this.parseDate(i)),
          t.isFunction(n) && n.call(this.$element, i) === !1)
        )
          return;
        (this.date = i),
          (this.viewDate = new Date(i)),
          s || this.pick(),
    ...
    (d.setDefaults = function (e) {
      t.extend(d.DEFAULTS, t.isPlainObject(e) && e);
    }),
    (d.other = t.fn.datepicker),
      ...
      return (
        this.each(function () {
          ...
          if (!o) {
            ...
            (s = t.extend({}, h.data(), t.isPlainObject(i) && i)),
              h.data(p, (o = new d(this, s)));
          }
          e(i) && t.isFunction((n = o[i])) && (a = n.apply(o, r));
        }),
        s(a) ? this : a
      );
    }),
    (t.fn.datepicker.Constructor = d),
    (t.fn.datepicker.languages = d.LANGUAGES),
    (t.fn.datepicker.setDefaults = d.setDefaults),
    (t.fn.datepicker.noConflict = function () {
      return (t.fn.datepicker = d.other), this;
    });
});
