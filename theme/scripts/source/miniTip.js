...
(function ($) {
  $.fn.miniTip = function (opts) {
    ...
    if (!$("#miniTip")[0])
      $("body").append(
        '<div id="miniTip"><div id="miniTip_t"></div><div id="miniTip_c"></div><div id="miniTip_a"></div></div>',
      );
    ...
    return this.each(function () {
      ...
      if (cont != "" && typeof cont != "undefined") {
        ...
        if (!o.content) el.removeAttr("title");
        ...
        if (o.event == "hover") {
          ...
          el.click(function () {
            ...
            if (tt_w.data("last_target") !== el) {
              ...
              if (tt_w.css("display") == "none") show.call(this);
              else hide();
            }
            ...
            $("html")
              ...
              .click(function (e) {
                if (
                  tt_w.css("display") == "block" &&
                  !$(e.target).closest("#miniTip").length
                ) {
                  $("html").unbind("click");
                  hide();
                }
        ...
        var show = function () {
          ...
          if (o.title != "") tt_t.html(o.title).show();
          else tt_t.hide();
          ...
          if (isArea) {
            ...
            var mapImg = el.parent().attr("name"),
              ...
              left =
                parseInt(mapOff.left, 10) +
                parseInt(
                  (parseInt(x.sort(num)[0], 10) +
                    parseInt(x.sort(num)[x.length - 1], 10)) /
                    2,
                  10,
                ),
              top =
                parseInt(mapOff.top, 10) +
                parseInt(
                  (parseInt(y.sort(num)[0], 10) +
                    parseInt(y.sort(num)[y.length - 1], 10)) /
                    2,
                  10,
                );
          } else {
          ...
          if (wOut || (o.anchor == "e" && !eOut)) {
            if (o.anchor == "w" || o.anchor == "e") {
              elPos = "e";
              aTop = Math.round(
                tipH / 2 - 8 - parseInt(tt_w.css("borderRightWidth"), 10),
              );
            ...
            if (o.anchor == "w" || o.anchor == "e") {
              elPos = "w";
              aTop = Math.round(
                tipH / 2 - 8 - parseInt(tt_w.css("borderLeftWidth"), 10),
              );
          ...
          tt_a
            .css({
              "margin-left":
                (aLeft > 0 ? aLeft : aLeft + parseInt(o.stemOff, 10) / 2) +
                "px",
              "margin-top": aTop + "px",
            })
            .attr("class", elPos);
          ...
          delay = setTimeout(function () {
            tt_w
              .css({ "margin-left": mLeft + "px", "margin-top": mTop + "px" })
              .stop(true, true)
              .fadeIn(o.fadeIn);
          }, o.delay);
        };
