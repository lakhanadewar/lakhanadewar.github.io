      ...
      return (
        this.each(function () {
          function s(t) {
            if (c) {
              ...
              e(s)
                ...
                .is(y.parent()) && r(i, !0),
                t.preventDefault && !m && t.preventDefault(),
                m || (t.returnValue = !1);
            }
          }
          function r(e, t, i) {
            ...
            if (
              (t &&
                ((s =
                  parseInt(R.css("top")) +
                  ((e * parseInt(o.wheelStep)) / 100) * R.outerHeight()),
                (s = Math.min(Math.max(s, 0), r)),
                (s = e > 0 ? Math.ceil(s) : Math.floor(s)),
                R.css({ top: s + "px" })),
              (f =
                parseInt(R.css("top")) / (y.outerHeight() - R.outerHeight())),
              (s = f * (y[0].scrollHeight - y.outerHeight())),
              i)
            ) {
            ...
            (b = f),
              g >= y.outerHeight()
                ...
                : (R.stop(!0, !0).fadeIn("fast"),
                  o.railVisible && E.stop(!0, !0).fadeIn("fast"));
          }
          function n() {
            o.alwaysVisible ||
          ...
          if (y.parent().hasClass(o.wrapperClass)) {
            var x = y.scrollTop();
            if (
              ((R = y.siblings("." + o.barClass)),
              (E = y.siblings("." + o.railClass)),
              a(),
              e.isPlainObject(i))
            ) {
              ...
              if ("scrollTo" in i) x = parseInt(o.scrollTo);
                ...
                return R.remove(), E.remove(), void y.unwrap();
              r(x, !1, !0);
            }
            ...
            E.css(D),
              ...
              y.bind("touchmove", function (e) {
                m || e.originalEvent.preventDefault(),
                  e.originalEvent.touches.length &&
                    (r(
                      (d - e.originalEvent.touches[0].pageY) /
                        o.touchScrollStep,
              ...
              a(),
              "bottom" === o.start
                ? (R.css({ top: y.outerHeight() - R.outerHeight() }), r(0, !0))
                : "top" !== o.start &&
                  (r(e(o.start).position().top, null, !0),
                  o.alwaysVisible || R.hide()),
              (function (e) {
