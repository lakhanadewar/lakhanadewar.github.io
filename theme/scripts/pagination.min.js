...
!(function (t, s, i, e) {
  ...
  var a = t.fn.twbsPagination,
    o = function (i, e) {
      if (
        ((this.$element = t(i)),
        (this.options = t.extend({}, t.fn.twbsPagination.defaults, e)),
      ...
      if (
        ...
        (o = o.replace(this.options.hrefVariable, "(\\d+)")),
          null != (a = new RegExp(o, "i").exec(s.location.href)) &&
  ...
  (o.prototype = {
    ...
    buildListItems: function (s) {
      ...
      for (var a = 0; a < s.numeric.length; a++)
        i = i.add(this.buildItem("page", s.numeric[a]));
      if (this.options.next) {
        var o =
          s.currentPage < this.options.totalPages
            ? s.currentPage + 1
            : this.options.loop
            ? 1
            : this.options.totalPages;
    ...
    buildItem: function (s, i) {
      ...
      return (
        e.data("page", i),
        e.data("page-type", s),
        e.append(a.attr("href", this.makeHref(i)).html(o)),
        e
      );
    },
    getPages: function (t) {
      var s = [],
        ...
        a = t + i;
      0 >= e && ((e = 1), (a = this.options.visiblePages)),
        a > this.options.totalPages &&
          ((e = this.options.totalPages - this.options.visiblePages + 1),
          (a = this.options.totalPages));
    ...
    render: function (s) {
      this.$listContainer.children().remove(),
        this.$listContainer.append(this.buildListItems(s));
      var i = this.$listContainer.children();
      i
        .filter(function () {
          return (
            t(this).data("page") === s.currentPage &&
            "page" === t(this).data("page-type")
          );
        })
        ...
        i
          ...
          .toggleClass(this.options.disabledClass, 1 === s.currentPage),
        i
          .filter(function () {
        ...
        i
          ...
          .toggleClass(
            this.options.disabledClass,
            !this.options.loop && 1 === s.currentPage,
          ),
        i
          .filter(function () {
          ...
          .toggleClass(
            this.options.disabledClass,
            !this.options.loop && s.currentPage === this.options.totalPages,
          );
    },
    setupEvents: function () {
      ...
      this.$listContainer.find("li").each(function () {
        ...
        return (
          i.off(),
          i.hasClass(s.options.disabledClass) ||
          i.hasClass(s.options.activeClass)
            ? void i.click(function (t) {
                t.preventDefault();
              })
            : void i.click(function (t) {
                !s.options.href && t.preventDefault(),
                  s.show(parseInt(i.data("page"), 10));
              })
        );
      });
    },
    makeHref: function (t) {
      return this.options.href
        ? this.options.href.replace(this.options.hrefVariable, t)
        : "#";
    },
  }),
    (t.fn.twbsPagination = function (s) {
      var i,
        ...
        l = "object" == typeof s && s;
      return (
        r || n.data("twbs-pagination", (r = new o(this, l))),
        "string" == typeof s && (i = r[s].apply(r, a)),
        i === e ? n : i
      );
    }),
