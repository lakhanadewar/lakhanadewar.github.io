...
!(function (t) {
  ...
  var e = function (i, n) {
    (this.$element = t(i)),
      (this.options = t.extend({}, e.DEFAULTS, this.dataOptions(), n)),
      this.init();
  };
  (e.DEFAULTS = {
    from: 0,
    ...
    (t.fn.countTo = function (i) {
      return this.each(function () {
        ...
        (!s || "object" == typeof i) &&
          (s && s.stop(), n.data("countTo", (s = new e(this, a)))),
          s[r].call(s);
      });
    });
}),
    ...
    (e.prototype = {
      ...
      initFill: function () {
          ...
          if (1 == r.length) this.arcFill = r[0];
            ...
            for (
              var o = n.gradientAngle || 0,
                ...
                h = s.createLinearGradient.apply(s, l),
                c = 0;
              c < r.length;
              c++
            ) {
        ...
        n.image &&
          ...
          e.complete ? u() : (e.onload = u));
        function u() {
          var n = t("<canvas>")[0];
          (n.width = i.size),
            (n.height = i.size),
            n.getContext("2d").drawImage(e, 0, 0, a, a),
    ...
    t.fn.downCount = function (e, i) {
      ...
      var r = setInterval(function () {
        ...
        var e = Math.floor(t / 864e5),
          ...
          h = Math.floor((t % 6e4) / 1e3),
          c = 1 === (e = String(e).length >= 2 ? e : "0" + e) ? "day" : "days",
          d =
            1 === (o = String(o).length >= 2 ? o : "0" + o) ? "hour" : "hours",
          f =
        ...
        s.find(".days").text(e),
          s.find(".hours").text(o),
          s.find(".minutes").text(l),
          s.find(".seconds").text(h),
          s.find(".days_ref").text(c),
          s.find(".hours_ref").text(d),
          s.find(".minutes_ref").text(f),
          s.find(".seconds_ref").text(u);
      }, 1e3);
    };
  })(jQuery);
(function ($) {
      ...
      formatter: function (value, options) {
        return (
          value
            ...
            .replace(/\B(?=(?:\d{3})+(?!\d))/g, separator) + unit
        );
      },
    });
